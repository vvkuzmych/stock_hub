...
//	cfg := config.Load()
//
//	// Initialize message service for logging
//	messageService, err := service.NewMessageService(cfg.DatabasePath)
//	if err != nil {
//		log.Fatalf("Failed to initialize message service: %v", err)
//	}
//	defer messageService.Close()
//
//	// Get database connection from message service (we'll need to refactor this)
//	// For now, create a new connection for other services
//	db := messageService.GetDB()
//	userService := service.NewUserService(db)
//	orderService := service.NewStockOrderService(db)
//
